...
export default function PrivacyPage() {
  ...
  return (
    <main>
      ...
      <section id="hero-section" className="bg-gradient-to-br from-white to-mintwell-light py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center items-center text-sm text-gray-500">
            <span className="flex items-center"><FontAwesomeIcon icon={faCalendarDays} className="mr-2" aria-hidden="true" />Last updated: {lastUpdated}</span>
            <span className="flex items-center"><FontAwesomeIcon icon={faClock} className="mr-2" aria-hidden="true" />Quick read</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <a key={idx} href={i.href} className="flex items-center p-4 rounded-lg border border-gray-200 hover:border-mintwell-teal hover:bg-mintwell-teal/5 transition-all group">
      ...
      <section id="introduction" className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-6">Mintwell maintains high standards of data privacy and security for advisors and their clients. This page explains how we collect, use, and protect your information.</p>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm">Your financial information is handled with care and is only accessible to your designated advisor.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Security and Rights stubs to be expanded next */}
      ...
      <section id="user-rights" className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl border border-gray-100 p-8">
            ...
            <p className="text-gray-700 text-sm">You may access, update, or request deletion of your personal information. Contact privacy@mintwell.ai for requests.</p>
          </div>
        </div>
      </section>
    </main>

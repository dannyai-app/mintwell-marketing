    ...
    <main>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <a href="/for-advisors" className="bg-mintwell-blue hover:bg-blue-800 text-white px-8 py-4 rounded-xl font-bold uppercase text-lg transition-all duration-200 shadow-lg hover:shadow-xl text-center">Start Free Trial</a>
                <a href="#report-generation" className="border-2 border-mintwell-teal text-mintwell-teal hover:bg-mintwell-teal hover:text-white px-8 py-4 rounded-xl font-bold uppercase text-lg transition-all duration-200 text-center">Watch Demo</a>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 border-t-4 border-mintwell-blue">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-mintwell-navy">6 months</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Debt-to-Income</span>
                    <span className="font-medium text-mintwell-navy">18%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Retirement Savings</span>
                    <span className="font-medium text-mintwell-navy">On Track</span>
                  </div>
                </div>
                <div className="mt-6">
      ...
      <section id="faq-section" className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <FAQ id={4} color="border-purple-500" q="Is Mintwell compliant with financial regulations?">
              <p>Yes, Mintwell is designed with regulatory compliance in mind. We maintain SOC 2 Type II certification, use bank-level encryption, and follow FINRA guidelines for financial advisor tools. Regular compliance audits ensure ongoing adherence.</p>
            </FAQ>
            <FAQ id={5} color="border-yellow-500" q="What kind of support do you provide?">
              <p>We offer comprehensive support including email assistance for all plans, priority support for Professional users, and dedicated account management for Enterprise clients. Our knowledge base and video tutorials help you get the most out of Mintwell.</p>
            </FAQ>
            <FAQ id={6} color="border-red-500" q="Can I try Mintwell before committing to a paid plan?">
              <p>Yes! Every plan includes a 14-day free trial with full access to all features. No credit card required to start your trial. Experience the complete Mintwell platform and see how it can transform your practice risk-free.</p>
            </FAQ>
          </div>
        </div>
      </section>
      ...
      <section id="cta-section" className="py-20 bg-gradient-to-r from-mintwell-blue to-mintwell-teal">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a href="/for-advisors" className="bg-white text-mintwell-blue hover:bg-gray-100 px-8 py-4 rounded-xl font-bold uppercase text-lg transition-all duration-200 shadow-lg hover:shadow-xl">Start Free Trial</a>
            <a href="#report-generation" className="border-2 border-white text-white hover:bg-white hover:text-mintwell-blue px-8 py-4 rounded-xl font-bold uppercase text-lg transition-all duration-200">Schedule Demo</a>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 border-t-4 border-mintwell-blue">
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <FontAwesomeIcon icon={faCheck} className="text-white text-2xl" aria-hidden="true" />
                </div>
                <h3 className="text-2xl font-bold text-mintwell-navy mb-2">Security Certifications</h3>
                <p className="text-gray-600">Independently verified security and compliance standards</p>
              </div>
      ...
      <section id="testimonials-section" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                name: "David Thompson",
                title: "CFP®, Thompson Financial",
                text: "Mintwell has revolutionized how I work with new clients. The professional reports impress prospects and the streamlined process saves me hours each week.",
                border: "border-mintwell-blue",
              },
              {
                avatar: "https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-5.jpg",
                name: "Sarah Mitchell",
                title: "Principal, Mitchell Wealth Management",
                text: "My clients love the visual health scores and clear recommendations. It's made complex financial planning accessible and engaging for everyone.",
                border: "border-mintwell-teal",
              },
              {
                avatar: "https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-8.jpg",
                name: "Michael Rodriguez",
                title: "Senior Advisor, Pinnacle Financial",
                text: "The setup was incredibly simple and my first client report looked like it came from a Fortune 500 firm. Mintwell has elevated my entire practice.",
                border: "border-green-500",
              },
            ].map((t, i) => (
              <div key={i} className={`bg-mintwell-light rounded-2xl p-8 border-t-4 ${t.border}`}>
                <div className="flex items-center mb-6">
                  <img className="w-12 h-12 rounded-full mr-4" src={t.avatar} alt="Advisor" />
                  <div>
                    <h4 className="font-bold text-mintwell-navy">{t.name}</h4>
          ...
          <div className="mt-16 bg-gradient-to-r from-mintwell-blue to-mintwell-teal rounded-2xl p-12 text-center">
            <h3 className="text-3xl font-bold text-white mb-6">Join 500+ Advisors Growing Their Practice</h3>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <div className="text-blue-100">Reports Generated</div>
              </div>
              <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={i} className="flex items-center">
                    <FontAwesomeIcon icon={faCheck} className="text-mintwell-teal mr-3" aria-hidden="true" />
                    <span className="text-gray-700">{t}</span>
                  </li>
                ))}
              </ul>
              <button className="w-full border-2 border-mintwell-blue text-mintwell-blue hover:bg-mintwell-blue hover:text-white py-3 rounded-xl font-bold uppercase transition-all duration-200">
                Start Free Trial
              </button>
            </div>
            {/* Professional */}
            <div className="bg-white rounded-2xl p-8 shadow-2xl border-t-4 border-mintwell-blue relative">
              ...
              <button className="w-full bg-mintwell-blue hover:bg-blue-800 text-white py-3 rounded-xl font-bold uppercase transition-all duration-200">
                Start Free Trial
              </button>
            </div>
            {/* Enterprise */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-mintwell-teal">
              ...
              <button className="w-full border-2 border-mintwell-teal text-mintwell-teal hover:bg-mintwell-teal hover:text-white py-3 rounded-xl font-bold uppercase transition-all duration-200">
                Contact Sales
              </button>
            </div>
          </div>
          <div className="text-center mt-12">
            ...
            <div className="flex justify-center items-center space-x-6">
              <div className="flex items-center">
                <FontAwesomeIcon icon={faShieldHalved} className="text-mintwell-teal mr-2" aria-hidden="true" />
              ...
              <div className="flex items-center">
                <FontAwesomeIcon icon={faArrowsRotate} className="text-mintwell-teal mr-2" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="text-center">
                ...
                <h3 className="text-xl font-bold text-mintwell-navy mb-4">{["Sign Up & Setup","Invite Clients","Track Progress","Generate Reports"][idx]}</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="text-mintwell-teal hover:text-mintwell-blue text-sm font-medium">View All</button>
                </div>
                <div className="space-y-4">
